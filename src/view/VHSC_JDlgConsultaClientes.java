 ...
 * @author Marcos
 */
public class VHSC_JDlgConsultaClientes extends javax.swing.JDialog {
  VHSC_ControllerConsultasClientes controllerConsultasClientes;
    /**
     * Creates new form JDlgClientesPesquisar
     */
 
    public VHSC_JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta Clientes");
   
        controllerConsultasClientes = new VHSC_ControllerConsultasClientes();
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if ((jTxtNome.getText().isEmpty() == false) && (jTxtCpf.getText().isEmpty() == false)){
            lista = (List) clientesDAO.listNomeCpf(jTxtNome.getText(), jTxtCpf.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VHSC_JDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VHSC_JDlgConsultaClientes dialog = new VHSC_JDlgConsultaClientes(new javax.swing.JFrame(), true);
