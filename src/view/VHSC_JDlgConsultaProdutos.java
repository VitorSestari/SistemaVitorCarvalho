 ...
 * @author Marcos
 */
public class VHSC_JDlgConsultaProdutos extends javax.swing.JDialog {
  VHSC_ControllerConsultasProdutos controllerConsultasProdutos;
    /**
     * Creates new form JDlgUsuariosPesquisar
     */
 
    public VHSC_JDlgConsultaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultaa Produtos");
   
        controllerConsultasProdutos = new VHSC_ControllerConsultasProdutos();
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        // TODO add your handling code here:
        vhsc_ProdutosDAO produtosDAO = new vhsc_ProdutosDAO();
        List lista;
        if ((jTxtNome.getText().isEmpty() == false) && (jTxtValor.getText().isEmpty() == false)){
            lista = (List) produtosDAO.listNomeValor(jTxtNome.getText(), VHSC_Util.strToDouble(jTxtValor.getText()));
            ...
            lista = (List) produtosDAO.listValor(VHSC_Util.strToDouble(jTxtValor.getText()));
        }else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VHSC_JDlgConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VHSC_JDlgConsultaProdutos dialog = new VHSC_JDlgConsultaProdutos(new javax.swing.JFrame(), true);
