 ...
 * @author Marcos
 */
public class VHSC_JDlgConsultaVendas extends javax.swing.JDialog {
  VHSC_ControllerConsultasVendas controllerConsultasVendas;
    /**
     * Creates new form JDlgUsuariosPesquisar
     */
 
    public VHSC_JDlgConsultaVendas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultaa Vendas");
   
        controllerConsultasVendas = new VHSC_ControllerConsultasVendas();
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        List lista;
        if ((jTxtFormaPagamento.getText().isEmpty() == false) && (jTxtValorTotal.getText().isEmpty() == false)){
            lista = (List) vendasDAO.listFormaPagamentoValor(jTxtFormaPagamento.getText(), VHSC_Util.strToDouble(jTxtValorTotal.getText()));
            ...
            lista = (List) vendasDAO.listValorTotal(VHSC_Util.strToDouble(jTxtValorTotal.getText()));
        }else {
    ...
    private void jBtnGerarPdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGerarPdfActionPerformed
        // TODO add your handling code here:
        VHSC_Util.gerarPDF(jTable1, "Relatório de Vendas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VHSC_JDlgConsultaVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VHSC_JDlgConsultaVendas dialog = new VHSC_JDlgConsultaVendas(new javax.swing.JFrame(), true);
