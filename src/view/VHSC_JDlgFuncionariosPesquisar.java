...
public class VHSC_JDlgFuncionariosPesquisar extends javax.swing.JDialog {
     ...
     */
   private VHSC_JDlgFuncionarios VHSC_jDlgFuncionarios;
    VHSC_ControllerFuncionarios controllerFuncionarios;
    ...
    public VHSC_JDlgFuncionariosPesquisar(java.awt.Frame parent, boolean modal) {
        ...
        controllerFuncionarios = new VHSC_ControllerFuncionarios();
        vhsc_FuncionariosDAO vhsc_funcionariosDAO = new vhsc_FuncionariosDAO();
        List lista = (List) vhsc_funcionariosDAO.listAll();
        controllerFuncionarios.setList(lista);
        jTable1.setModel(controllerFuncionarios);
    }
    
    public void setTelaAnterior(VHSC_JDlgFuncionarios VHSC_jDlgFuncionarios) {
    this.VHSC_jDlgFuncionarios = VHSC_jDlgFuncionarios;
   }
